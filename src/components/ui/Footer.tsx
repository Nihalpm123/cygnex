...
export default function Footer() {
    return (
        <footer className="bg-zinc-50/60 border-t border-zinc-200/80 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    <h4 className="text-zinc-900 font-bold text-sm mb-4 uppercase tracking-wider">Services</h4>
                ...
                <div>
                    <h4 className="text-zinc-900 font-bold text-sm mb-4 uppercase tracking-wider">Company</h4>
                    <ul className="space-y-2 text-sm text-zinc-550">
                ...
                <div>
                    <h4 className="text-zinc-900 font-bold text-sm mb-4 uppercase tracking-wider">Connect</h4>
            ...
            <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-zinc-200 text-center text-xs text-zinc-400">
