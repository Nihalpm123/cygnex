        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {works.map((work, index) => (
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="group relative overflow-hidden rounded-2xl bg-zinc-50 border border-zinc-200 aspect-[4/3] cursor-pointer shadow-md hover:shadow-lg transition-all duration-300"
                >
                    <Image
                        src={work.image}
                        alt={work.title}
